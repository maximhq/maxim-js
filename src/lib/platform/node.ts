...
const net = {
  httpAgent: (options?: Record<string, unknown>): HttpAgentLike => new HttpAgent(options as any) as any,
  httpsAgent: (options?: Record<string, unknown>): HttpAgentLike => new HttpsAgent(options as any) as any,
};
